...
A more generic {\it heterodyned} model, assuming gravity is described by some metric theory, but not necessarily GR, is given by
...
and scalar (`b' and `l') \gw amplitude components, $F_{p}$ are their associate antenna responses (not defined as a function
of $\psi$ as above) \citep[see, e.g.][]{2009PhRvD..79h2002N,2012PhRvD..85d3005B}, and $\Phi_{\text{t,v,s}}$ and $\psi_{\text{t,v,s}}$ are angles related to the initial
