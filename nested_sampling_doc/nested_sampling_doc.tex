...
(e.g.\ using a Markov chain Monte Carlo \cite{2010ApJ...713..671A}). This method has been variously called
the {\it Time Domain Method}, the {\it Heterodyne Method}, the {\it Bayesian Method}, the {\it Glasgow
...
estimation code has been re-written to use the nested sampling algorithm \cite{Skilling:2006}. This allows us
to evaluate the {\it evidence} or {\it marginal likelihood} for the signal model and compare it to other
