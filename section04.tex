...
the actual signal), with standard devaitions wide enough to encompass the true signal values. The recovered signal posterior distributions can be seen
...
the heterodyne parameter values, i.e.\ the centres of the Gaussian priors).
