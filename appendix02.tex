...
\begin{enumerate}
 ...
 the {\it Spectral Interpolation} method described in \citep{0264-9381-34-1-015010}. Files must be in ascii text format with three
 ...
 \verb|900000000 1.2564374e-22 -4.5764347e-22|. The data does not have to be uniformly sampled and can contain gaps. However,
...
{\tt T2} model are implemented). The code can use the TDB or TCB time systems. The code can accept {\tt .par} files
calculated using the JPL DE200, DE405, DE414, or DE421 solar system ephemerides, noting that it only takes into
account the motion of the Earth-Moon system and the Sun, but no other solar system bodies.
