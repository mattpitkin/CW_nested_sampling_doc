...
$h_0$ and $\phi_0$ values via $h_0 = -2C_{22}$ \cite[where the minus sign maintains consistency with the form given in][]{1998PhRvD..58f3001J} and $\phi_0 = \Phi_{22}^C/2$. For the more general case the
